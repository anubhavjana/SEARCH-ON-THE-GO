...
$rowcount=mysqli_num_rows($result);
   if($rowcount>=1)
    { 
	    echo "<h4><b><i>Hello Customer Here You Go!!!</i></b></h4> <br> <br> "; 
		while($row=mysqli_fetch_assoc($result))
		{
			...
			elseif($start==$row["destination5"]&&$dest==$row["destination4"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination5"]&&$dest==$row["destination3"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination5"]&&$dest==$row["destination2"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination5"]&&$dest==$row["destination1"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination5"]&&$dest==$row["start"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination4"]&&$dest==$row["destination3"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination4"]&&$dest==$row["destination2"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination4"]&&$dest==$row["destination1"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination4"]&&$dest==$row["start"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination3"]&&$dest==$row["destination2"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination3"]&&$dest==$row["destination1"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination3"]&&$dest==$row["start"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination2"]&&$dest==$row["destination1"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination2"]&&$dest==$row["start"])
			{
		
			
			echo "YOU SHOULD TRAVEL BY BUS NO:   ". $row["busno"] ."<br><br><br>";
			}
			elseif($start==$row["destination1"]&&$dest==$row["start"])
			{
